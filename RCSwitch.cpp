...
void RCSwitch::transmit(HighLow pulses) {
  ...
  // printf("HIGH %d * %d = %d\n", this->protocol.pulseLength, pulses.high, (this->protocol.pulseLength * pulses.high));
  digitalWrite(this->nTransmitterPin, LOW);
  delayMicroseconds( this->protocol.pulseLength * pulses.low);
  // printf("LOW %d * %d = %d\n", this->protocol.pulseLength, pulses.low, (this->protocol.pulseLength * pulses.low));
}
